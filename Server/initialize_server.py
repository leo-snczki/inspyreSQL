...
def start_check_use_db():
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS medico ( id INT AUTO_INCREMENT PRIMARY KEY ,nif CHAR(9) UNIQUE, nome VARCHAR(255) NOT NULL, idade INT NOT NULL, email VARCHAR(255) UNIQUE NOT NULL, senha VARCHAR(255) NOT NULL, especialidade VARCHAR(100) NOT NULL, salario DECIMAL(10,2) NOT NULL)")
    cursor.execute("CREATE TABLE IF NOT EXISTS paciente ( id INT AUTO_INCREMENT PRIMARY KEY ,nif CHAR(9) UNIQUE, nome VARCHAR(255) NOT NULL, idade INT NOT NULL, email VARCHAR(255) UNIQUE NOT NULL, senha VARCHAR(255) NOT NULL, utente VARCHAR(50) NOT NULL)")
